...
EuClusterCore::EuClusterCore(int argc   , char **argv,double angle_region_):angle_region(angle_region_)
{
    ...
    parameters = new Parameter( "/home/hrt19d/parameter/Parameters.json" );
    ...
    pub_bounding_boxs_ = nh.advertise<jsk_recognition_msgs::BoundingBoxArray>("/detected_bounding_box", 1);
...
void EuClusterCore::point_cb(const sensor_msgs::PointCloud2ConstPtr &in_cloud_ptr  )
{
    ...
    point_cloud_header_.stamp = ros::Time::now();
